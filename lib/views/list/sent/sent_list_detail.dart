...
class SentListDetail extends StatefulWidget {
  const SentListDetail({super.key});

  @override
  _SentListDetailState createState() => _SentListDetailState();
}

class _SentListDetailState extends State<SentListDetail> {
  int? openIndex;
            ...
            child: BorderedContainer(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 7.h),
                  const CustomInfoRow(title: "Nội dung:", value: "Vận chuyển"),
                  SizedBox(height: 7.h),
                  const CustomInfoRow(
            ...
            child: BorderedContainer(
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      const CustomStatusBadge(
                          status: "Đã gửi", color: AppColors.lightBlueColor)
                    ],
                  ),
                  SizedBox(height: 3.h),
                  const Divider(),
                  ...
                  SizedBox(height: 7.h),
                  const CustomInfoRow(
                      title: "Ngày MATC phản hồi:", value: "Chưa phản hồi"),
                  SizedBox(height: 7.h),
                  const CustomInfoRow(
