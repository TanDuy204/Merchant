...
class TruckScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance
        .addPostFrameCallback((_) => truckController.getAllTrucks());
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          Obx(() {
            ...
            if (truckController.filteredTrucks.isEmpty) {
              return SliverFillRemaining(
                hasScrollBody: false,
                child: Center(
                  child: Text(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                truckController.getStatusColor(truck.status!),
