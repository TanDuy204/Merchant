        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Thông tin tài khoản", style: AppTextStyles.titleMedium()),
                ...
                Column(
                  ...
                  children: [
                    ...
                    _buildCustomTextField(context, nameController, hint: "tên"),
          ...
          SliverToBoxAdapter(
            ...
            child: Column(
              ...
              children: [
                const SizedBox(height: 7),
                Text("Cập nhật mật khẩu", style: AppTextStyles.titleMedium()),
                const SizedBox(height: 4),
                Text(
                ...
                Column(
                  ...
                  children: [
                    ...
                    _buildCustomTextField(context, oldPassController, hint: ""),
                    _buildLabel(context, "Mật khẩu mới"),
                    _buildCustomTextField(context, newPassController, hint: ""),
          ...
          SliverToBoxAdapter(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Xác thực hai yếu tố", style: AppTextStyles.titleMedium()),
                const SizedBox(height: 7),
                Text(
          ...
          SliverToBoxAdapter(
            child: BorderedContainer(
              child: Column(
                ...
                children: [
                  const SizedBox(height: 7),
                  Text("Xóa tài khoản", style: AppTextStyles.titleMedium()),
                  const SizedBox(height: 4),
                  Text(
  ...
  Widget _buildCustomTextField(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        hintText: hint,
        hintStyle:
            AppTextStyles.bodyMedium().copyWith(color: AppColors.greyColor),
        filled: true,
