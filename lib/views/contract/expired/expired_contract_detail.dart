...
class ExpiredContractDetail extends StatefulWidget {
  const ExpiredContractDetail({super.key});

  @override
  State<ExpiredContractDetail> createState() => _ExpiredContractDetailState();
}

class _ExpiredContractDetailState extends State<ExpiredContractDetail> {
  int? openIndex;
  @override
